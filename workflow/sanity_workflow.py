...
class SanityWorkflow:
    ...
    def __init__(html):
        ...
        if driver.title == "Mac - Apple":
            ...
            ScreenCaptureUtils.take_screenshot("Sanity_TC_01")
        ...
        if driver.title == "Apple":
            ...
            ScreenCaptureUtils.take_screenshot("Sanity_TC_02")
        ...
        if driver.title == "iPad - Apple":
            ...
            ScreenCaptureUtils.take_screenshot("Sanity_TC_03")
        ...
        if driver.title == "iPhone - Apple":
            ...
            ScreenCaptureUtils.take_screenshot("Sanity_TC_04")
        ...
        if driver.title == "Apple Card - Monthly Installments -Apple":
            ...
            ScreenCaptureUtils.take_screenshot("Sanity_TC_05")
        return html
